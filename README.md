...
SDK não-oficial de integração á API do serviço www.tiny.com.br
...
use Softr\TinyERP\Adapter\BuzzAdapter;
use Softr\TinyERP\Adapter\GuzzleAdapter;
use Softr\TinyERP\Adapter\GuzzleHttpAdapter;
use Softr\TinyERP\TinyERP;
...
// Instancie o cliente TinyERP usando a instância do adapter previamente criada.
...
$asaas = new TinyERP($adapter, 'producao|homologacao');
```
...
[Para reportar um novo bug por favor abra um novo Issue no github](https://github.com/softr/tinyerp-php-sdk/issues)
